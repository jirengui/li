...
public class JifenduihuanLiwuFragment extends Fragment  {

    private PullToRefreshLayout pullToRefreshLayout;
    private RecyclerView rcJifenduihuanLiWu;
    private RcShangPingAdapter adapter;
    private List<LiWuBean> list = new ArrayList<>();
    private List<LiWuBean> list1 = new ArrayList<>();//礼物是1
            ...
            switch (msg.what) {
                case 11:
                    ...
                    if (adapter == null) {
                        ...
                        rcJifenduihuanLiWu.setLayoutManager(new LinearLayoutManager(getContext()));
                        rcJifenduihuanLiWu.setAdapter(adapter);
                    }else {
                        System.out.println("礼物适配器不为空"+ list1.get(0).getName());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.jifenduihuan_liwu, null);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        pullToRefreshLayout = (PullToRefreshLayout) view.findViewById(R.id.pu_liwu);
        rcJifenduihuanLiWu = (RecyclerView) view.findViewById(R.id.rc_jifenduihuan_liwu);
        adapter = new RcShangPingAdapter(list1, getContext());
        rcJifenduihuanLiWu.setLayoutManager(new LinearLayoutManager(getContext()));
        rcJifenduihuanLiWu.setAdapter(adapter);
