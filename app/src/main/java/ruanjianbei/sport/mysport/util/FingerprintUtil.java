...
import ruanjianbei.sport.mysport.activity.DaohangActivity;
...
public class FingerprintUtil {
    ...
    public static  void callFingerPrint(final OnCallBackListenr listener){
        ...
        System.out.println("指纹context：" + MyApplication.context );
        System.out.println("指纹isHardwareDetected：" +managerCompat.isHardwareDetected());
